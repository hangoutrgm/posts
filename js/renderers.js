    ...
    const generatePostReactionsUI = () => {
        ...
        const triggerHtml = `
            <div class="relative group flex shrink-0">
                ...
                <div class="absolute bottom-full left-0 mb-1 invisible opacity-0 flex group-hover:visible group-hover:opacity-100 transition-all duration-300 delay-300 group-hover:delay-0 items-center space-x-1.5 bg-white dark:bg-slate-800 p-1.5 rounded-full shadow-lg border border-gray-100 dark:border-slate-700 z-50">
    ...
    const generateCommentReactionsUI = (c, cId) => {
        ...
        const triggerHtml = `
            <div class="relative group flex shrink-0">
                ...
                <div class="absolute bottom-full left-0 mb-1 invisible opacity-0 flex group-hover:visible group-hover:opacity-100 transition-all duration-300 delay-300 group-hover:delay-0 items-center space-x-1 bg-white dark:bg-slate-800 p-1 rounded-full shadow-lg border border-gray-100 dark:border-slate-700 z-50">
                    ${['like', 'heart', 'haha', 'wow', 'sad', 'angry'].map(t => `
